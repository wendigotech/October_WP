                    ...
                    <div> 
                        <?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><article <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
                            ...
                            <footer class="entry-footer"> 
                                <?php if ( has_tag() ) : ?><span class="tags-links"><?php the_tags( 'Tags: ', ', ' ); ?></span><?php endif; ?> 
                        ...
                        <?php if ( comments_open() || get_comments_number() || is_page() ) : ?><?php comments_template( '/comments.php' ); ?><?php endif; ?>                                         
                    </div>                                     
                </main>                                 
            </div>                             
