                    ...
                    <div> 
                        <?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><article <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
                            ...
                            <?php
                                    ...
                                    ?><?php $exclusive = new WP_Query( $exclusive_args ); ?><?php if ( $exclusive->have_posts() ) : ?><div class="grid3" id="post-<?php the_ID(); ?>">
                                <?php $exclusive_item_number = 0; ?><?php while ( $exclusive->have_posts() && $exclusive_item_number++ < 5 ) : $exclusive->the_post(); ?><figure class="effect-ruby effect-ruby-3">
