...
get_header(); ?>
                ...
                <div id="page-wrapper" class="wrapper mt-5 pt-5 mb-5 pb-5 d-flex justify-content-around"> 
                    <div class="content-area col-md-8" id="primary" style="background-color: #e2e2eb;"> 
                                        ...
                                        <article <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
                                            ...
                                            <div class="entry-content d-flex"> 
                                                ...
                                                <?php if ( $random->have_posts() ) : ?>
                                                    <div class="bonus-column col-sm-4 col-4 pl-2 d-flex flex-column col-md-4" id="post-<?php the_ID(); ?>"> 
                    ...
                    <?php if ( $best_offer->have_posts() ) : ?>
                        <div role="complementary" id="right-sidebar-<?php the_ID(); ?>" <?php post_class( 'widget-area col-md-3' ); ?>> 
                            <?php $best_offer_item_number = 0; ?>
                            <?php while ( $best_offer->have_posts() && $best_offer_item_number++ < 4 ) : $best_offer->the_post(); ?>
