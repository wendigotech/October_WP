                                                ...
                                                <?php while ( $best_bonuses->have_posts() && $best_bonuses_item_number++ < 1 ) : $best_bonuses->the_post(); ?>
                                                    <figure <?php post_class( 'effect-ruby effect-ruby-1' ); ?> id="post-<?php the_ID(); ?>">
                                                        ...
                                                        <figcaption>
                                                            ...
                                                            <div>
                                                                <a class="btn btn-light btn-visit" href="#"><?php echo get_post_meta( get_the_ID(), 'link1', true ); ?></a>
                                                                <a class="btn btn-light" href="<?php echo get_post_meta( get_the_ID(), 'link2', true ); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo get_post_meta( get_the_ID(), 't&cs', true ); ?>"><?php _e( 'T&amp;C\'s Apply', 'october' ); ?></a>
                                                            </div>
                                                        </figcaption>
                                                    </figure>
                                                <?php endwhile; ?>
