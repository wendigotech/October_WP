                        ...
                        <?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><article <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
                                ...
                                <div id="carousel1" class="carousel slide" data-ride="carousel"> 
                                    <div class="carousel-inner"> 
                                        <div class="carousel-item active"> 
                                            <?php if ( is_active_sidebar( 'blog1' ) ) : ?><div class="row" style="margin-left: 0; margin-right: 0;"><?php dynamic_sidebar( 'blog1' ); ?></div><?php endif; ?>                                                             
                                        </div>
                                        <div class="carousel-item"> 
                                            <?php if ( is_active_sidebar( 'blog2' ) ) : ?><div class="row" style="margin-left: 0; margin-right: 0;"><?php dynamic_sidebar( 'blog2' ); ?></div><?php endif; ?>                                                             
                                        </div>
                                        <div class="carousel-item"> 
                                            <?php if ( is_active_sidebar( 'blog3' ) ) : ?><div class="row" style="margin-left: 0; margin-right: 0;"><?php dynamic_sidebar( 'blog3' ); ?></div><?php endif; ?>                                                             
                                        </div>                                                         
                                    </div>
                            ...
                            <div class="mt-5 mb-5 container" id="content" tabindex="-1" style="background-color: rgba(191, 193, 203, 0);"> 
                                ...
                                <?php
                                    ...
                                    <?php $info_item_number = 0; ?><?php while ( $info->have_posts() && $info_item_number++ < 4 ) : $info->the_post(); ?><div class="mb-2 col-lg-12 container d-flex col-md-12">
