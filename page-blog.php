...
<div id="page-wrapper" class="wrapper mt-5 pt-5 mb-5 pb-5 d-flex"> 
    <div class="container">
        <div class="row">
            <div class="content-area col-12 ml-0 col-md-11 ml-md-5 col-lg-11" id="primary" style="background-color: rgba(226, 226, 235, 0.77); border-radius: 3px;"> 
    ...
    <div role="complementary" class="col-sm-12 d-none col-8 d-md-inline col-md-3 mr-md-5 col-lg-3"> 
        <div class="sidebar">
            <row>
                <?php
                    $big_args = array(
