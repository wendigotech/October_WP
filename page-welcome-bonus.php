                    ...
                    <div> 
                        <?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><article <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
                            ...
                            <?php
                                    ...
                                    ?><?php $welcome = new WP_Query( $welcome_args ); ?><?php if ( $welcome->have_posts() ) : ?><div class="grid3" id="post-<?php the_ID(); ?>">
                                <?php $welcome_item_number = 0; ?><?php while ( $welcome->have_posts() && $welcome_item_number++ < 5 ) : $welcome->the_post(); ?><figure class="effect-ruby effect-ruby-3">
