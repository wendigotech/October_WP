    ...
    <nav class="container navigation post-navigation pt-3 pb-3"> 
        <h2 class="sr-only"><?php _e( 'Post navigation', 'october' ); ?></h2> 
        <div class="row nav-links justify-content-between"> 
            <span class="nav-previous"><?php previous_post_link( '%link', __( '&laquo; %title', 'october' ) ); ?></span> 
            <span class="nav-next"><?php next_post_link( '%link', __( '%title &raquo;', 'october' ) ); ?></span> 
        </div>         
        <!-- .nav-links -->         
    </nav>     
