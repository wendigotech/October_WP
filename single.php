            ...
            <div class="content-area col-md-12 " id="primary"> 
                <main class="site-main" id="main"> 
                    <div> 
                        ...
                        ?><?php $random_payments = new WP_Query( $random_payments_args ); ?><?php if ( $random_payments->have_posts() ) : ?><div class="entry-content mt-5"><?php echo get_post_meta( get_the_ID(), 'tag1', true ); ?></div><?php else : ?><p><?php _e( 'Sorry, no posts matched your criteria.', 'october' ); ?></p><?php endif; ?>                                         
                    </div>                                     
                </main>                                 
            </div>
        </div>
