                    ...
                    <div> 
                        <?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><article <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
                            ...
                            <?php
                                    ...
                                    ?><?php $popular = new WP_Query( $popular_args ); ?><?php if ( $popular->have_posts() ) : ?><div class="grid3" id="post-<?php the_ID(); ?>">
                                <?php $popular_item_number = 0; ?><?php while ( $popular->have_posts() && $popular_item_number++ < 5 ) : $popular->the_post(); ?><figure class="effect-ruby effect-ruby-3">
